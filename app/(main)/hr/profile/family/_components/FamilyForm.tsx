...
export default function FamilyForm({ maritalStatus, spouse: initSpouse, children: initChildren, prevStep, nextStep }: {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      {!isMarried && <p className="text-sm text-muted-foreground italic">Spouse section is available for married employees. Update your marital status in <a href="/hr/profile/personal" className="underline">Personal Info</a>.</p>}
